...
public class JFPerson extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txfLastName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txfLastNameKeyTyped(evt);
            }
        });
...
//        String dni = (String) jTable1.getValueAt(filasel, 0);
        String lastName = (String) jTable1.getValueAt(filasel, 0);
        String name = (String) jTable1.getValueAt(filasel, 1);
        String date1 = (String) jTable1.getValueAt(filasel, 2);
        Date date = formatBirthday.parse(date1);
        String place = (String) jTable1.getValueAt(filasel, 3);
...
//                controllerPerson.updatePerson(dni, lastName, name, date, place);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (yesnoResponse == JOptionPane.YES_OPTION) {
            controllerPerson.deltePersonString(lastName, name, name, name);
        } //else {
...
//        controllerPerson.searchPerson(jTable1, dni);
    ...
    private void txfLastNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txfLastNameKeyTyped
        // TODO add your handling code here:
        char keyPressed = evt.getKeyChar();
        if (keyPressed == KeyEvent.VK_ENTER) {
            txfName.requestFocus();
        }
    }//GEN-LAST:event_txfLastNameKeyTyped
